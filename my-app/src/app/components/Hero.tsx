...
export default function Hero() {
  ...
  const totalPages = Math.ceil(products.length / itemsPerPage);
    return (  <div className='bg-gradient-to-r from-black via-red-950 to-black '>
     ...
     w-{100%} '>
         ...
         <h2 className='text-white text-5xl mt-28 font-bold'>Unlimited movies,<br/> TV shows, and more</h2>
          </div>
       <div className="container mx-auto px-4 py-6  ">
   
         <h1 className="text-xl text-white  text-center mb-11 mt-2">Starts at Rs 250. Cancel anytime.</h1>
        
         {/* Product Grid */}
         <div className="grid grid-cols-1 sm:grid-cols-2 cursor-pointer md:grid-cols-3 lg:grid-cols-4 gap-10">
